<?php
// Charger le .env si $_ENV est vide
if (empty($_ENV['SMTP_HOST2'])) {
...
{
    $host     = $_ENV['SMTP_HOST2']      ?? '';
    $port     = (int)($_ENV['SMTP_PORT2'] ?? 587);
    $username = $_ENV['SMTP_USER2']      ?? '';
    $password = $_ENV['SMTP_PASS2']      ?? '';
    $from     = $_ENV['SMTP_FROM2']      ?? '';
    $fromName = $_ENV['SMTP_FROM_NAME2'] ?? 'Theatro INSAT';
